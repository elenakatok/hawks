 ...
 */
export const updateGroupContract = onCall({ cors: hawksGameDef.corsOrigins }, async (request) => {
  ...
  if (agreement_reached) {
    ...
    const check = validateOutcome(hawksGameDef.outcomeSchema, provided as Outcome)
    if (!check.valid) {
